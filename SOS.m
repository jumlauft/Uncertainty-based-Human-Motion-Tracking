...
N=1e4; E = 2; dSOS = 2; x=rand(E,N); exMat = getExpoMatrix(E,dSOS);
Pr = randn(size(exMat,1)); P = tril(Pr)*tril(Pr)';
[V] = SOS(x,P,dSOS);
[n,num,ana] = checkGrad(@SOS,1,1,2,{x,P,dSOS});
[n,num,ana] = checkGrad(@SOS,2,1,3,{x,P,dSOS});
%}
%
% Copyright (c) by Jonas Umlauft under BSD License 
% Last modified: Jonas Umlauft, Armin Lederer, 05/2017
